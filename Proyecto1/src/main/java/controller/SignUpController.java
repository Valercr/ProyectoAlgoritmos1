...
//            util.UtilityFX.alert("Error","Complete todos los espacios",Alert.AlertType.ERROR);
//        } else if (!password.equals(confirmPassword)) { // Verificar si las contraseñas no coinciden
//            util.UtilityFX.alert("Trate de nuevo","Las contraseñas no coinciden",Alert.AlertType.WARNING);
//        } else {
